...
public class TypesMXBeanImpl implements TypesMXBean {
	...
	public TypesMXBeanImpl(Instrumentation aInstrumentation, String aId) {
		INSTRUMENTATION = aInstrumentation;
		BYTECODES = new ArrayList<byte[]>(); //TODO: concurrent
